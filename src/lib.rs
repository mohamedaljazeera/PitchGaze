...
#[derive(Debug)]
pub struct PitchGazeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PitchGazeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PitchGaze processing");
    
    let mut processor = PitchGazeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PitchGazeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PitchGazeProcessor::new(false);
